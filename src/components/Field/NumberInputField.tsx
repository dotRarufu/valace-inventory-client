...
const NumberInputField = ({ label, value, isUpdate, handleChange }: Props) => {
  useEffect(() => {
    // todo: causes error in log, fix this
      ...
      {!isUpdate ? (
        ...
        <div className=" flex justify-between items-start ">
          ...
          <input
            ...
            placeholder=""
            onChange={e => handleChange && handleChange(Number(e.target.value))}
            value={value}
          />
        </div>
      )}
